<?php
//this will be our people-view page, which of course start with our include, pointing to our config, BUT NOT header inclde!
include('config.php');
...
<p><a href="people.php">Return to the peope page!</a></p>
</main>
