...
session_start();
include('config.php');
//this is where enentually you will have the header include here
...
//we want to make sure that all input fields have been filled out.
...
//our logic is this password_1 !==  password_2


if($password_1 !== $password_2){
    array_push($errors, 'Passwor do not match!!');
}

//we are checking the username and password ...AND selscting if from the table
...
//we are going to have an if statement, and we will nest 2 additional if statements inside our mail if statement
...
//Now is time to insert the information in our table 
...
}//close if clount errors

}//end if isset reg_user

//We must communicate with the login page - we will ask the same question
...
//we will count our errors, we hope zero errors
...
//below a new variable is results Not result 
