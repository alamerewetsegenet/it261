...
<head>
    ...
    <title>Currency 3with drop down(select and option)</title>
...
<fieldset>
    ...
    <!--time for our radio button that has aVALUEn additional attribute of -->
...
<option value="us" <?php if(isset($_POST['bank']) && $_POST['bank'] == 'us') echo 'selected = selected"' ;?>> US Bank</option>
...
<div class="box">
<h2>Hello '.$name.',</h2>
<p>You now have <b>$'.number_format($dollars, 2).' American dollars</b> and we will be emailing you at <b>'.$email.'</b> with your informayion as well as depositing your funds at <b>'.$bank.' bank!</b><!p>
</div>
';
if($dollars >= 1000){

    echo '<h1 style="text-align:center;">I am REALLY happy, because I have '.number_format($dollars, 2).'<br> American dollars!</h1>
    
        <p align="center"><iframe width="560" height="315" src="https://www.youtube.com/embed/Fkk9DI-8el4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
        ';
    }else 
    echo '<div style=" background-color:#bbb; max-width:560px;  align:center; margin:0 auto;"><h1 text-align="center;">I am not happy, because I have '.number_format($dollars, 2).'<br> American dollars!</h1>
