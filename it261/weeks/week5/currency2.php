...
<head>
    ...
    <title>Currency 2 with drop down(select and option)</title>
...
<div class="box">
<h2>Hello '.$name.'</h2>
<p>You now have <b>$'.floor($dollars).' American dollars</b> and we will be emailing you at <b>'.$email.'</b> with your informayion as well as depositing your funds at <b>'.$bank.' bank!</b><!p>
