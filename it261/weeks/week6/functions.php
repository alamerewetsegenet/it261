...
echo '<h2>Aritmetic problems - cube</h2>';
function cube($num){
$cubing = $num * $num  *$num;
echo $cubing;
}
...
echo '<h2>Our navigation cerated with a function!</h2>';

echo make_links($nav);

echo '<h2>The impload function!</h2>';

$cars = array('toyota', 'ford', 'subaru', 'audio', 'bmw', 'mercedes', 'lexus');

$my_cars = implode(', ', $cars);
echo $my_cars;
echo '<h2>The logic behind the wines on our form </h2>
<p>If post wines is not empty, take post wines and impload them, and creat a new variable named $my_wines </p>
