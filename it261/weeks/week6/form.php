...
<fieldset>
<legend>Contact Etsegenet</legend>
...
<ul>
<li>
<input type="radio" name="gender" value="male" <?php if(isset($_POST['gender']) && $_POST['gender'] == 'male') echo 'checked ="checked"'     ;?>>Female
</li>
</ul>
<ul>
<li>
<input type="radio" name="gender" value="female" <?php if(isset($_POST['gender']) && $_POST['gender'] == 'female') echo 'checked ="checked"'     ;?>>Male
</li>
</ul>
<ul>
<li>
...
<input type="submit" vlaue="send it!">
