...
if(isset($_GET['today'])) {
   ...
   you’ll be fixing it often. —Anne Troise, Manalapan, New Jersey.</p>';
   break;
   ...
   $alt = 'Cereal';
   $content = '<p> <b>What’s better than exploring the cereal</b> aisle at a grocery store? With a large variety of 
   flavors, there’s a cereal option out there for everyone. Cereal is another quick and easy breakfast option, 
